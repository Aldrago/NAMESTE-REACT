...
const Restaurant = (props) => {
  ...
  return (
    <div className="m-4 p-4 w-[300px] rounded-lg bg-gray-100 content-center">
      <img
...
export const withPromotedLabel = (Restaurant) => {
  return (props) => {
    return (
      <div>
        <label className="absolute bg-black text-white p-1 rounded-lg bg-opacity-[0.7] ">Promoted</label>
        <Restaurant {...props} />
      </div>
    );
  };
